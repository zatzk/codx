    ...
    <div className='flex bg-dark-layer-1 bottom-0 sticky z-10 w-full'>
      <div className='mx-5 my-[10px] flex justify-between w-full'>
        <div className='ml-auto flex items-center space-x-4'>
          ...
          <button
            className='border border-green-400  hover:bg-green-400 px-4 py-2 font-medium items-center transition-all focus:outline-none inline-flex text-sm text-green-400 hover:text-white bg-dark-green-s hover:bg-green-3 rounded-lg'
            onClick={onSubmit}
          >
            Submit
          </button>
